<template>
  <div>
    ...
    <el-row>
      <el-col :span="5"><div class="grid-content bg-purple ">{{'店铺/平台名称'}}</div></el-col>
      <el-col :span="19"><div class="grid-content bg-purple-light " @click="">{{'aaaa'}}</div></el-col>
    </el-row>
    <el-row>
    ...
    <!--合同签订below-->
    <el-row>
      <el-col :span="24"><div class="grid-content bg-purple-dark" style="margin: 1em 0">合同签订</div></el-col>
    </el-row>
    <!--content-->
    <el-form ref="form" :model="form" label-width="80px" style="margin-top: 1em">
      <el-form-item label="">
        ...
        <el-col :span="6" style="margin-right: 1em">
          <el-date-picker type="date" placeholder="开始时间(修改时间)" v-model="form.date1" style="width: 100%;"></el-date-picker>
        </el-col>
        <el-col class="line" :span="1"> </el-col>
        <el-col :span="6" style="margin-right: 1em">
          <el-time-picker type="date" placeholder="结束时间(修改时间)" v-model="form.date2" style="width: 100%;"></el-time-picker>
        </el-col>
        <el-col :span="5">
