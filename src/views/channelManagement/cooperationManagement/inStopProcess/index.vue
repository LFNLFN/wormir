<template>
  <div style="padding: 1em">
    ...
    <!-- border2 border-width:2px;border-right-width: 1px-->
    <el-table border :data="channelTableData" class="" style="width: 100%;border-top: 1px solid #D5D5D5;border-left: 1px solid #D5D5D5">
