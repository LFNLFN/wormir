<template>
  <div>
    ...
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 400px;" class="filter-item" placeholder="商品码/操作账号/接收邮箱"
    ...
    <el-row :gutter="5">
      <el-col :span="21" align="left"><div class="grid-content bg-purple">已生成发送{{totalCount}}个商品码</div></el-col>
    </el-row>

    <!--清单-->
    <el-table key='productList' :data="list" border fit highlight-current-row :summary-method="getSummaries" show-summary
