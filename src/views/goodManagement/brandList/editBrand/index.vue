<template>
  <div>
    <el-form ref="form" :model="form" label-width="150px" :rules="formRules">
      <div class="border1 form-error-inline">
        ...
        <el-form-item
          label="外汇到账时间"
          prop="receiptTime"
          class="form-row last-form-row add-brand-row"
        >
          <el-col :span="11">
      ...
      <el-form-item label="合作管理" required v-if="this.form.contract">
        ...
        >
          <el-table-column prop="contractNo" align="center" min-width="140" label="合同编号"></el-table-column>
          <el-table-column prop="contractProp" align="center" min-width="100" label="合同属性"></el-table-column>
          <el-table-column prop="beginTime" align="center" min-width="120" label="开始时间"></el-table-column>
          <el-table-column prop="endTime" align="center" min-width="120" label="结束时间"></el-table-column>
          <el-table-column prop="brandStatus" align="center" min-width="110" label="品牌状态"></el-table-column>
          <el-table-column prop="endDate" align="center" min-width="120" label="终止日期"></el-table-column>
          <el-table-column prop="endType" align="center" min-width="110" label="终止类型"></el-table-column>
          <el-table-column prop="endReason" align="center" min-width="140" label="终止原因"></el-table-column>
    ...
    <el-dialog
      :visible.sync="isStopContractShow"
      class
      width="70%"
      ...
      >
        <div class="border1">
          ...
          >
            <el-input
              type="textarea"
              placeholder="请输入终止合作原因"
              :rows="2"
              v-model="stopContract_ruleForm.applyReason"
              style="margin: 3px;width: 98%"
            ></el-input>
          </el-form-item>
          <el-form-item label="品牌状态" class="form-row add-brand-row last-form-row">
            <el-select
              v-model="stopContract_ruleForm.brandStatus"
              placeholder="请选择"
              style="margin: 3px;"
            >
              <el-option
