...
">
      ...
      <el-row>
        ...
        <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{goodsObject.goodPromotionApplication.firstPromotionQuantities}}</span>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="3" class="no-border-right">
          <el-input class="noBorderInput" v-model="quantity" placeholder="输入申请数量"></el-input>
        </el-col>
        <el-col :span="1" class="noBackground"><span>套</span></el-col>
        <el-col :span="0"></el-col>
        <el-col :span="3">库存数量</el-col>
        <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{goodsObject.currentInventoryQuantity}}</span>
        </el-col>
        <el-col :span="1" class="noBackground"><span>套</span></el-col>
      </el-row>
  ...
  export default {
    ...
    methods: {
      submitApplication() {
        ...
        let file = this.$refs.upload.$refs[0];
        ...
        if (diff >= 35) {
          var data = {
            ...
            startDate: this.getTime(this.dateRange[0]),
            endDate: this.getTime(this.dateRange[1]),
            // fileName: file.name,
            // fileUrl: file.url
          }
          // this.$request({
          //   url: "/goodsInfo/firstDLQDGoodPromotionApplication.do",
          //   method: "post",
          //
          // }).then((res) => {
