  ...
  <div class="app-container">
    <div class="theBorder">
      ...
      <el-row>
        ...
        <el-col :span="21">
          <div class="grid-content bg-purple" v-if="goodsObject.goodPromotionApplication">{{ goodsObject.goodPromotionApplication.first_apply_reason }}</div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="3" align="center">
        ...
        <el-col :span="10" style="height: 34px;padding-left: 1em">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            {{goodsObject.goodPromotionApplication.firstPromotionStartTime | parseTime('{y}-{m}-{d}')}}-{{goodsObject.goodPromotionApplication.firstPromotionEndTime | parseTime('{y}-{m}-{d}')}}</div>
        </el-col>
      </el-row>

      <el-row>
        <el-col :span="3">申请数量</el-col>
        <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{goodsObject.goodPromotionApplication.firstPromotionQuantities}}</span></el-col>
