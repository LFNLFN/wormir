  ...
  <div class="app-container">
    <div class="theBorder">
      ...
      <el-row>
        ...
        <el-col :span="21">
          <div class="grid-content bg-purple" v-if="goodsObject.goodPromotionApplication">{{ goodsObject.goodPromotionApplication.againApplyReason }}</div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="3" align="center">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">{{goodsObject.goodPromotionApplication.againPromotionStartTime | parseTime('{y}-{m}-{d}')}}-{{goodsObject.goodPromotionApplication.againPromotionEndTime | parseTime('{y}-{m}-{d}')}}</div>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="2" class="no-border-right" style="display: flex;justify-content: center"><span>{{goodsObject.goodPromotionApplication.againApprovedQuantities}}</span></el-col>
        <el-col :span="1" class="noBackground"><span>套</span></el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :offset="3" :span="6"
                style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start">
          <div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{
            $t('order.reviewTime') }}: {{ goodsObject.goodPromotionApplication.againCheckTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}') }}
          </div>
        </el-col>
      </el-row>
      ...
      <el-row class="no-border-bottom">
        ...
        <el-col :span="6" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start;padding-left: 1em">
          <div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{ goodsObject.goodPromotionApplication.againCheckTime |
            parseTime('{y}-{m}-{d}') }} -- {{ goodsObject.goodPromotionApplication.againCheckTime-60000*60*24*30 | parseTime('{y}-{m}-{d}') }}
          </div>
        </el-col>
      </el-row>
    </div>
