    ...
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.goodPromotionApplication">
        ...
        <el-row>
          ...
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{item.firstApprovedQuantities}}</span></el-col>
        ...
        <template v-if="item.applicationResult === 1">
          ...
          <el-row>
            <el-col :offset="3" :span="6" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start"><div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{ $t('order.reviewTime') }}: {{ item.firstCheckTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}') }}</div></el-col>
          </el-row>

          <el-row class="no-border-bottom">
            <el-col :span="3">订货时间</el-col>
            <el-col :span="6" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start;padding-left: 1em"><div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{ item.firstCheckTime | parseTime('{y}-{m}-{d}') }}
        ...
        <template v-if="item.applicationResult === 2">
          <el-row>
            <!--<el-col :offset="3" :span="3">批准数量</el-col>-->
            <el-col :span="3">批准数量</el-col>
            <el-col :span="2" style="display: flex;justify-content: center"><span>{{item.firstPromotionQuantities}}</span></el-col>
            <el-col :span="1"><span>套</span></el-col>
          </el-row>
          <el-row class="no-border-bottom">
            <el-col :span="3">订货时间</el-col>
            <el-col :span="6" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start;padding-left: 1em"><div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{ item.firstCheckTime | parseTime('{y}-{m}-{d}') }}
        ...
        <template v-if="item.applicationResult === 3">
          ...
          <el-row class="no-border-bottom">
            <el-col :offset="3" :span="3">驳回说明</el-col>
