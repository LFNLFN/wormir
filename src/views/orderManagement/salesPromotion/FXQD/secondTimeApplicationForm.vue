    ...
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.goodPromotionApplication">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-date-picker class="noBorderDatePicker" v-model="item.againPromotionStartTime" type="daterange"
        ...
        <el-row v-if="item.secondApplication">
        ...
        <el-row>
          <el-col :span="3" v-if="item.firstApprovedQuantities">再申请数量</el-col>
          <el-col :span="3" v-else>申请数量</el-col>
          <el-col :span="3" style="border-right: none">
            <el-input class="noBorderInput"  v-model="item.againApprovedQuantities" placeholder="输入申请数量"></el-input>
          </el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
          <el-col :span="0"></el-col>
          <el-col :span="3">库存数量</el-col>
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{goodsObject.currentInventoryQuantity}}</span></el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
        </el-row>
