    ...
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.goodPromotionApplication">
        ...
        <el-row>
          ...
          <el-col :span="21">
            <div class="grid-content bg-purple">{{ item.againApplyReason }}</div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="3" align="center">
        ...
        <el-row>
          ...
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{item.againApprovedQuantities}}</span></el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
        </el-row>
