<template>
  <div>
    <div style="text-align: center"><h3>收货单</h3></div>
    <div class="rowFlex">
      <div class="filter-container theTopMsgBorder no-border-bottom" :style="{paddingBottom: 0, width: rowLength+'px'}">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <div class="grid-content bg-purple">{{ '独立渠道' }}</div>
          </el-col>
        </el-row>
        <el-row>
    ...
    <div class="rowFlex">
      ...
      <div class="twoTable-wrap border-top1">
        ...
        <div class="filter-container" style="padding-bottom: 0">
          <el-table key='productList' :data="order.orderSubs || []"
            ...
            <el-table-column align="center" width="90" label="国内售价">
              <template slot-scope="scope">
            ...
            <el-table-column align="center" width="100" label="发货装箱规格">
              <template slot-scope="scope">
                <span>{{ scope.row.packingSpecification }} 瓶/箱</span>
              </template>
            </el-table-column>
        ...
        <div class="filter-container">
          <el-table key='replenishment' :data="order.replenishmentList" border fit
            ...
            <el-table-column align="center" width="100" label="发货装箱规格">
              <template slot-scope="scope">
                <span v-if="scope.$index===order.replenishmentList.length-1" style="color:gray"></span>
      ...
      <div class="brand-col">
        <div class="col-head border-bottom border-right2 border-top1 qr-col">发货日期</div>
