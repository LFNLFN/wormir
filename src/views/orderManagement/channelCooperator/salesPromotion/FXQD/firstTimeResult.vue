    ...
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.FXMSG">
        ...
        <el-row>
          ...
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>350</span></el-col>
        ...
        <template v-if="item.applicationResult === 2">
          <el-row>
            ...
            <el-col :span="2" style="display: flex;justify-content: center"><span>250</span></el-col>
