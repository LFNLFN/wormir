<template>
  <div>
    <div class="topTitle colFlex">
      ...
      <br>
      <br>
      <h1 style="text-align:center">装箱单</h1>PACKING LIST
      <br>
      <br>
    </div>
    <div class="topTable theBorder no-border-bottom" style="margin: 0 10%">
      <el-row>
        <el-col :span="6" align="center">
          <div class="grid-content bg-purple">{{ '箱单编号/Packing List No：' }}</div>
        </el-col>
        <el-col :span="10">
    ...
    <div class="bottomTable" style="margin: 0 10%">
      <el-table
        ...
        size="mini"
        style="width: 100%"
        class="theBorder orderTable border-left2 no-border-bottom border-right2 border-top2"
        ref="invoiceTable"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span class="text-total" style="font-weight:bold">{{ netWeightTotal }}</span>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
        ...
        >
          <template slot-scope="scope">
            <span class="text-total" style="font-weight:bold">{{ grossWeightTotal  }}</span>
          </template>
        </el-table-column>
      </el-table>
      <div class="bottomTable theBorder">
        ...
        <el-row>
          <el-col :span="4" align="center">
            <div class="grid-content bg-purple">{{ 'Total in' }}</div>
          </el-col>
          <el-col :span="14">
            <div class="grid-content bg-purple">{{ shipmentQuantityTotal + ' ' + 'Carton' }}</div>
          </el-col>
        </el-row>
      </div>
    </div>
  ...
  methods: {
    ...
    getGoodList() {
      ...
      this.$request({
        ...
        .then(res => {
          if (res.errorCode == 0) {
            this.grossWeightTotal = 0
            this.netWeightTotal = 0
            this.shipmentQuantityTotal = 0
            this.invoiceTableList = res.data.items
            this.invoiceTableList.forEach((e,i,s) => {
              this.grossWeightTotal += e.gross_weight
              this.netWeightTotal += e.net_weight
              this.shipmentQuantityTotal += e.shipment_quantity
            })
          }
        })
        .catch(err => {
