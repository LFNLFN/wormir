<template>
  <div>
    <div class="topTitle colFlex">
      <h1 style="text-align:center">Manufacture's Production Date Certification</h1>
      <br>
      <br>
    </div>
    ...
    <div class="bottomTable" style="margin: 0 10%">
      ...
      >
        <el-table-column align="center" min-width="100" label="序号" prop="">
          <template slot-scope="scope">
            <span>{{ scope.$index+1 }}</span>
          </template>
        </el-table-column>
        <el-table-column align="center" min-width="100" label="货号" prop="goods_no_for_brand"/>
        <el-table-column align="center" min-width="190" label="商品名称" prop="goods_english_name"/>
        <el-table-column align="center" min-width="100" label="商品规格" prop="specification_english"></el-table-column>
        <el-table-column align="center" min-width="190" label="数量" prop="order_goods_num"/>
        <el-table-column align="center" min-width="100" label="生产日期" prop="productionDate"/>
        <el-table-column align="center" min-width="100" label="有效日期" prop="expirationDate"/>
        <el-table-column align="center" min-width="100" label="LOT NO" prop="lotNo">
          <template slot-scope="scope">
            <span>{{ scope.row.lotNo? scope.row.lotNo : '/' }}</span>
          </template>
        </el-table-column>
      </el-table>
      <div class="bottomTable theBorder" style="border-top:none">
        <el-row>
          <el-col align="center" style="background: #fff; margin-top:10px">
...
export default {
  ...
  methods: {
    ...
    getGoodList() {
      ...
      this.$request({
        url: "/goods/dateCertificationGoodList.do",
        method: "post",
        data: {
          orderNos: tmpArr
        }
