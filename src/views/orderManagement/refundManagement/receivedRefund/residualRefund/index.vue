  ...
  export default {
    ...
    props: {
      currentRow: {
        ...
        default: function() {
          return {
            isAlreadyRefund: 1, //待退款 或 已退款
            refundSituation: {
              // 待退款
              0: {
                // 渠道商认为待发货时间太长所以取消了
                refundReasonText: 'Retailer has waited too long for shipment and cancelled the order.',
                refundAmountTitle: 'Pending Refund of Full Payment：'
              },
              ...
              1: {
                // 渠道商认为待发货时间太长所以取消了
                refundReasonText: 'Retailer has waited too long for shipment and cancelled the order.',
                refundAmountTitle: 'Refunded Full Payment：'
              }
            }
          }
        }
