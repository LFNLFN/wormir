  ...
  <div class="app-container">
    <div class="theBorder">
      ...
      <el-row>
        ...
        <el-col :span="21">
          <div class="grid-content bg-purple">{{ applicatioiinReason }}</div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="3" align="center">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">2019 年 07 月 07 日--2019 年 07 月 15 日</div>
        </el-col>
      </el-row>

      <el-row>
        <el-col :span="3">申请数量</el-col>
        <el-col :span="2" class="no-border-right" style="display: flex;justify-content: center"><span>100</span></el-col>
      ...
      <el-row>
        <el-col :offset="3" :span="6"
          ...
          <div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{
            $t('order.applicationTime') }}: {{ new Date()-1000000 | parseTime('{y}-{m}-{d} {h}:{i}:{s}') }}
          </div>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="2" class="no-border-right" style="display: flex;justify-content: center"><span>50</span></el-col>
        <el-col :span="1" class="noBackground"><span>套</span></el-col>
      </el-row>
