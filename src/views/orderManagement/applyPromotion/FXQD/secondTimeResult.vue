<template>
  <div class="app-container">
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.FXMSG">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">2018 年 07 月 07 日--2018 年 07 月 15 日</div>
          </el-col>
        </el-row>

        <el-row>
          <el-col :span="3">已申请数量</el-col>
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{ item.firstReject? 0 : 200 }}</span></el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
        </el-row>
        <el-row>
          <el-col :span="3">再申请数量</el-col>
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>200</span></el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
        </el-row>
        <el-row>
        ...
        <template v-if="item.applicationResult === 1">
          ...
          <el-row class="no-border-bottom">
            ...
            <el-col :span="6" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start;padding-left: 1em"><div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999">{{ new Date()-1000000 | parseTime('{y}-{m}-{d}') }} -- {{ new Date('2019-07-07')-60000*60*24*30 | parseTime('{y}-{m}-{d}') }}</div></el-col>
          </el-row>
        </template>
        <!--同意但改数量-->
