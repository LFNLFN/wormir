    ...
    <div class="theBorder">
      ...
      <div v-for="(item, index) in goodsObject.FXMSG">
        ...
        <el-row v-if="item.secondApplication">
          ...
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>{{ item.firstReject? 0 : 100 }}</span></el-col>
        ...
        <el-row>
          ...
          <el-col :span="1" class="no-border-right" style="display: flex;justify-content: center"><span>1000</span></el-col>
          <el-col :span="1" class="noBackground"><span>套</span></el-col>
        </el-row>
