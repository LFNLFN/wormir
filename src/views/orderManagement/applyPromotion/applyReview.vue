    ...
    <div class="theBorder theTopMsgBorder">
      <el-row>
        <el-col :span="3" align="center" :style="{ height: tableHeight + 'px' }">
          <div class="grid-content bg-purple">{{propertyOfSale?'跨境贸易':'一般贸易'}}促销商品</div>
        </el-col>
      ...
      <template v-if="channelProp != 3">
        ...
        <el-row>
          ...
          <el-col :span="18" align="center" style="min-height: 64px;">

          </el-col>
          <el-col :span="3" style="padding-left: 1em;min-height: 64px;">
            <el-upload
              class="upload-demo"
          ...
          <el-row>
            ...
            <el-col :span="3">
              <div class="grid-content bg-purple">
                {{application_num}}
                <el-input v-model="application_num" placeholder="请输入内容"></el-input>
              </div>
            </el-col>
