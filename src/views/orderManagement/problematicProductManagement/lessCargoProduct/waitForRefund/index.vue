<template>
  <div>
    <h3 style="text-align: center">少货待退款</h3>
    <div class="theBorder">
      <el-row>
      ...
      <el-row>
        ...
        <span class="text-muted" v-if="currentRow.propertyOfSale==1">{{'退款将退回到您的帐户余额，完成补款后可查看您账户余额的变化情况。' }}</span>
          <span class="text-muted" v-if="currentRow.propertyOfSale==2">{{'退款将原路退回，完成退款后可查看您支付货款账户的金额变化情况。' }}</span>
        </el-col>
      </el-row>
      ...
      <template v-if="currentRow.compensation_type===25">
        ...
        <el-row>
          <el-col :offset="4" :span="12" style="background: #fff;font-weight: normal;border-bottom: none;justify-content: flex-start"><div class="text-muted" style="background-color: #fff;font-weight: normal;color: #999"><span class="text-muted" v-if="currentRow.propertyOfSale==1">{{'补款将退回到您的帐户余额，完成补款后可查看您账户余额的变化情况。' }}</span>
