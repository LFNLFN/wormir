      ...
      <div style="display: flex">
        ...
        <div class="twoTable-wrap" style="padding-right: 20px">
          ...
          <el-table :key=2 :data="totalTableData" border fit
            ...
            <el-table-column align="center" width="85" :label="$t('product.productNo')" prop="goodsNo">
              <template slot-scope="scope">
                <div class="text-muted" v-if="scope.$index==totalTableData.length-1">确认收货时间: {{ new
            ...
            <el-table-column align="center" width="90" :label="$t('price.domesticRetailPrice')">
              <template slot-scope="scope">
                <span v-if="scope.$index==totalTableData.length-1" class="text-total">{{ '合计: ' }}</span>
            ...
            <el-table-column align="center" width="120" class-name="units-wrap"
              ...
              <template slot-scope="scope">
                <el-row>
                  ...
                  <el-col :span="12" style="display: flex;justify-content: center">
                    <span v-if="scope.$index==totalTableData.length-1" class="text-total">箱</span>
                    <span v-else>箱</span>
                  </el-col>
                </el-row>
              </template>
            ...
            <el-table-column align="center" width="140" :label="$t('price.startDiscount')">
              <template slot-scope="scope">
                <div v-if="scope.$index==totalTableData.length-1" class="text-total">{{'已付货款'}} :
                </div>
            ...
            <el-table-column width="140" align="center" :label="$t('order.orderAmount')">
              <template slot-scope="scope">
                <span v-if="scope.$index==totalTableData.length-2" class="text-total">{{ '合计 : ' }}</span>
            ...
            <el-table-column align="center" width="130" :label="$t('order.thirtyPercentDeposit')">
              <template slot-scope="scope">
                ...
                <span v-else-if="scope.$index==totalTableData.length-1" class="text-total">￥ {{ (deposit30Amount+deposit70Amount).toFixed(2) }}</span>
...
//        4: 'FXZQD'
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        this.$refs['totalTable'].$el.children[2].children[0].children[1].children[this.totalTableData.length - 2].cells[0].style.textAlign = 'right'
        this.$refs['totalTable'].$el.children[2].children[0].children[1].children[this.totalTableData.length - 2].cells[1].style.textAlign = 'center'
        this.$refs['totalTable'].$el.children[2].children[0].children[1].children[this.totalTableData.length - 1].cells[0].style.textAlign = 'left'
        this.$refs['totalTable'].$el.children[2].children[0].children[1].children[this.totalTableData.length - 1].cells[1].style.textAlign = 'right'
        this.$refs['totalTable'].$el.children[2].children[0].children[1].children[this.totalTableData.length - 1].cells[3].style.textAlign = 'right'
